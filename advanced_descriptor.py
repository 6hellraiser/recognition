...
class Descriptor:
    ...
    def fifth(self, matrix):
      ...
      #  print matrix
       ...
       # print "fifth ",self.roundd(float(count)/(Descriptor.box_width*Descriptor.box_height))
    ...
    #    print "mean horizontal", mean_horizontal
        #print "sixth feature", self.roundd(sixth_feature)
    ...
    def seventh(self, matrix):
       ...
       # print "seventh ", self.roundd(seventh_feature)
    ...
    def eighth(self, matrix):
       ...
       # print "eighth ", self.roundd(eighth_feature)
    ...
    def nineth(self, matrix):
        ...
        #print "nineth ",self.roundd(nineth_feature)
    ...
    def tenth(self, matrix):
        ...
        for col in range(columns_count):
            ...
            y = 0
            x += 1
        #print "tenth ", self.roundd(float(sum)/Descriptor.on_pixels)
    ...
    def eleventh_twelfth(self, matrix):
       ...
       # print "eleventh ", eleventh_feature
       # print "twelfth ", twelfth_feature
    ...
    def thirteen_fourteen(self, matrix):
       ...
       # print "thirteen " ,thirteen_feature
       # print "fourteen " ,fourteen_feature
        return features
    ...
    def fifteen_sixteen(self, matrix):
       ...
       # print "fifteen ", fifteen_feature
       # print "sixteen ", sixteen_feature
        return features
